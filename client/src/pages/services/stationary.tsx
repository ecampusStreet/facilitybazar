...
const categories = [
  {
    ...
    description: "Premium pens, pencils, markers, and highlighters for every writing need.",
    items: ["Pens", "Pencils", "Markers", "Highlighters"]
  },
  {
    icon: FileText,
    title: "Paper Products",
    description: "High-quality paper supplies for all your documentation needs.",
  ...
  },
  {
    ...
    description: "Sustainable stationery products for environmentally conscious offices.",
        ...
        <div className="relative h-[400px] bg-gradient-to-r from-purple-600 to-purple-800">
          ...
          <div className="relative container mx-auto h-full flex items-center">
            <div className="text-white max-w-2xl">
              ...
              <p className="text-lg">
                Complete range of high-quality stationery and cleaning supplies for your business
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="container mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Explore our comprehensive range of office supplies designed to meet all your 
                business needs while maintaining professional standards.
              </p>
            </div>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl font-bold mb-6">Why Choose Our Supplies?</h2>
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Premium products from trusted manufacturers</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Best value for bulk orders and regular supplies</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="w-6 h-6 rounded-full bg-primary text-white flex items-center justify-center">3</span>
                    <div>
                      <h3 className="font-bold mb-1">Fast Delivery</h3>
                      <p className="text-gray-600">Efficient delivery service to your office</p>
                    </div>
                  </li>
                </ul>
                <Button size="lg" className="mt-8">Request Catalog</Button>
              </div>
              <img
                src="/img/office-supplies.jpg"
                alt="Office Supplies"
